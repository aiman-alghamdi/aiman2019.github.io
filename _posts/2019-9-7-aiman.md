...
## cleaning:
Befor we start any data scince project, we shoud clean the dataset and make sure the data are reday to analiys.
```python
...
Now After making some changes and cleaning for the detaset, here are some exploring of the date set.
